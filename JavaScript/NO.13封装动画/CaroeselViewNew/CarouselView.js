...
(function () {
    ...
    * */
    ...
    CarouselView.prototype.addPointerView = function () {
        var pointerBackgroundView = document.createElement("div");
        pointerBackgroundView.className = "carouselView-pointerBackgroundView";
        ...
        this.imagePaths.forEach(function (path) {
            ...
            pointerBackgroundView.appendChild(pointer);
        ...
        this.superEle.appendChild(pointerBackgroundView);
    };
